...
本文将介绍数据分析中几个最为常见的基本算法，先来了解一下其算法概念
...
![png](https://raw.githubusercontent.com/spiderwu/spiderwu.github.io/master/img/suanfa1/knn-1.png)
...
```python
rng = np.random.RandomState(8)	#定义随机种子
