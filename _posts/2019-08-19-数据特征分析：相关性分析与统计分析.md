...
> - 两个变量可以通过线性相关进行分析：
>
>     1、k>0：正相关，随着另一个变量的增大而增大；2、k<0：负相关，随着另一个变量的增大而减小
>
...
![png](https://raw.githubusercontent.com/spiderwu/spiderwu.github.io/master/img/xiangguanxfx/xgxfx-1.png)
...
数据特征分析的几个基本分析思路已学习完，分别有：分布分析、对比分析、帕累托分析、相关性分析以及统计分析。这五种分析思路是对数据特征进行分析的基础，可以引导自己快速将数据整理归类，记录下来以供随时翻阅，感谢阅读～
